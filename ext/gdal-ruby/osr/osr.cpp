...
SWIGINTERN VALUE
_wrap_SpatialReference_get_angular_units_name(int argc, VALUE *argv, VALUE self) {
  OSRSpatialReferenceShadow *arg1 = (OSRSpatialReferenceShadow *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_OSRSpatialReferenceShadow, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "OSRSpatialReferenceShadow *","GetAngularUnitsName", 1, self )); 
  }
  arg1 = reinterpret_cast< OSRSpatialReferenceShadow * >(argp1);
...
SWIGINTERN VALUE
_wrap_SpatialReference_get_axis_name(int argc, VALUE *argv, VALUE self) {
  OSRSpatialReferenceShadow *arg1 = (OSRSpatialReferenceShadow *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_OSRSpatialReferenceShadow, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "OSRSpatialReferenceShadow *","GetAxisName", 1, self )); 
  }
  arg1 = reinterpret_cast< OSRSpatialReferenceShadow * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","GetAxisName", 2, argv[0] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
  ecode3 = SWIG_AsVal_int(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "int","GetAxisName", 3, argv[1] ));
  } 
  arg3 = static_cast< int >(val3);
...
SWIGINTERN VALUE
_wrap_SpatialReference_get_axis_orientation(int argc, VALUE *argv, VALUE self) {
  OSRSpatialReferenceShadow *arg1 = (OSRSpatialReferenceShadow *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_OSRSpatialReferenceShadow, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "OSRSpatialReferenceShadow *","GetAxisOrientation", 1, self )); 
  }
  arg1 = reinterpret_cast< OSRSpatialReferenceShadow * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","GetAxisOrientation", 2, argv[0] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
  ecode3 = SWIG_AsVal_int(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "int","GetAxisOrientation", 3, argv[1] ));
  } 
  arg3 = static_cast< int >(val3);
...
SWIGEXPORT void Init_osr(void) {
  ...
  rb_define_const(mOsr, "SRS_WKT_WGS84", SWIG_FromCharPtr("GEOGCS[\"WGS 84\",DATUM[\"WGS_1984\",SPHEROID[\"WGS 84\",6378137,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]],AUTHORITY[\"EPSG\",\"6326\"]],PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\",\"8901\"]],UNIT[\"degree\",0.0174532925199433,AUTHORITY[\"EPSG\",\"9122\"]],AUTHORITY[\"EPSG\",\"4326\"]]"));
  ...
  rb_define_const(mOsr, "SRS_PT_QSC", SWIG_FromCharPtr("Quadrilateralized_Spherical_Cube"));
  rb_define_const(mOsr, "SRS_PT_AITOFF", SWIG_FromCharPtr("Aitoff"));
  rb_define_const(mOsr, "SRS_PT_WINKEL_I", SWIG_FromCharPtr("Winkel_I"));
  rb_define_const(mOsr, "SRS_PT_WINKEL_II", SWIG_FromCharPtr("Winkel_II"));
  rb_define_const(mOsr, "SRS_PT_WINKEL_TRIPEL", SWIG_FromCharPtr("Winkel_Tripel"));
  rb_define_const(mOsr, "SRS_PT_CRASTER_PARABOLIC", SWIG_FromCharPtr("Craster_Parabolic"));
  rb_define_const(mOsr, "SRS_PT_LOXIMUTHAL", SWIG_FromCharPtr("Loximuthal"));
  rb_define_const(mOsr, "SRS_PT_QUARTIC_AUTHALIC", SWIG_FromCharPtr("Quartic_Authalic"));
  rb_define_const(mOsr, "SRS_PT_SCH", SWIG_FromCharPtr("Spherical_Cross_Track_Height"));
  ...
  rb_define_const(mOsr, "SRS_PP_PEG_POINT_LATITUDE", SWIG_FromCharPtr("peg_point_latitude"));
  rb_define_const(mOsr, "SRS_PP_PEG_POINT_LONGITUDE", SWIG_FromCharPtr("peg_point_longitude"));
  rb_define_const(mOsr, "SRS_PP_PEG_POINT_HEADING", SWIG_FromCharPtr("peg_point_heading"));
  rb_define_const(mOsr, "SRS_PP_PEG_POINT_HEIGHT", SWIG_FromCharPtr("peg_point_height"));
  ...
  rb_define_const(mOsr, "OAO_OTHER", SWIG_From_int(static_cast< int >(0)));
  rb_define_const(mOsr, "OAO_NORTH", SWIG_From_int(static_cast< int >(1)));
  rb_define_const(mOsr, "OAO_SOUTH", SWIG_From_int(static_cast< int >(2)));
  rb_define_const(mOsr, "OAO_EAST", SWIG_From_int(static_cast< int >(3)));
  rb_define_const(mOsr, "OAO_WEST", SWIG_From_int(static_cast< int >(4)));
  rb_define_const(mOsr, "OAO_UP", SWIG_From_int(static_cast< int >(5)));
  rb_define_const(mOsr, "OAO_DOWN", SWIG_From_int(static_cast< int >(6)));
  ...
  rb_define_method(SwigClassSpatialReference.klass, "get_angular_units_name", VALUEFUNC(_wrap_SpatialReference_get_angular_units_name), -1);
  ...
  rb_define_method(SwigClassSpatialReference.klass, "get_axis_name", VALUEFUNC(_wrap_SpatialReference_get_axis_name), -1);
  rb_define_method(SwigClassSpatialReference.klass, "get_axis_orientation", VALUEFUNC(_wrap_SpatialReference_get_axis_orientation), -1);
